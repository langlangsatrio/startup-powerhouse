...
export default function Contact() {
  return (
    <div
      id="contact"
      className="page-layout flex h-full flex-col items-center justify-center gap-0 border-yellow-600 bg-white px-10 py-14 md:py-24 lg:mt-0 lg:flex-col lg:gap-4 lg:px-44 lg:py-44"
    >
